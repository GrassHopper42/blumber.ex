defmodule BlumberWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(BlumberWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(BlumberWeb.Gettext, "errors", msg, opts)
    end
  end
